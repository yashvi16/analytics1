...
fitted(fit2) # predicted sales values of input/ actual price and promotion
omni$sales
residuals(fit2) # diff b/t predicted and actual sales
...
#Assumptions
par(mfrow=c(2,2))# multiple frames for row
plot(fit2)
par(mfrow=c(1,1))
